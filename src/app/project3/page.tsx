      ...
      <main className="min-h-screen py-24 relative">
        <div className="container max-w-5xl px-6">
          ...
          >
            ...
            <span className="text-xs tracking-widest text-primary font-bold uppercase mb-2 block text-left">Educational Website</span>
            <h1 className="text-3xl sm:text-5xl font-extrabold text-white mb-6 leading-tight text-left">Xfini Academy</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start text-left">
            ...
            >
              ...
              <p className="text-text-muted leading-relaxed text-sm sm:text-base">
                Xfini Academy is a modern educational institution website designed to establish a strong digital presence while providing prospective students with easy access to information about courses, programs, faculty, and admission opportunities.
              </p>
              <p className="text-text-muted leading-relaxed text-sm sm:text-base">
                The platform serves as the primary online gateway for the academy, helping students explore educational offerings, learn about the institution, and connect with the academy through a streamlined and user-friendly experience. The website focuses on credibility, accessibility, and conversion-driven design to maximize student engagement and enquiry generation.
              </p>
              ...
              <ul className="flex flex-col gap-3 text-xs sm:text-sm text-text-muted list-disc list-inside pl-1">
                <li><strong>Course & Program Showcase:</strong> Present academic programs, certifications, and training opportunities in an organized format.</li>
                <li><strong>Institution Information Portal:</strong> Display academy vision, mission, achievements, and educational offerings.</li>
                <li><strong>Faculty & Trainer Profiles:</strong> Highlight instructors, qualifications, and areas of expertise.</li>
                <li><strong>Admission & Enquiry Forms:</strong> Enable prospective students to submit enquiries and request additional information.</li>
                <li><strong>Responsive User Experience:</strong> Optimized across desktop, tablet, and mobile devices.</li>
                <li><strong>Event & Announcement Management:</strong> Showcase workshops, seminars, admissions, and academy updates.</li>
                <li><strong>Contact & Communication Integration:</strong> Simplify communication through contact forms and social media integration.</li>
                <li><strong>SEO-Optimized Structure:</strong> Improve discoverability and online visibility for student acquisition.</li>
              </ul>

              <h3 className="text-lg font-bold text-white mt-4">Technical Execution</h3>
              <p className="text-text-muted leading-relaxed text-sm">
                Xfini Academy was developed as a modern institutional website with a focus on performance, responsiveness, and user engagement. The application utilizes a component-based architecture to efficiently manage educational content, course information, faculty profiles, and enquiry workflows.
              </p>
              <p className="text-text-muted leading-relaxed text-sm">
                The platform emphasizes clean information architecture, intuitive navigation, and mobile-first design principles to ensure a seamless browsing experience for prospective students and parents while supporting the academy's marketing and growth objectives.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="relative rounded-3xl p-1.5 bg-white/5 border border-white/10 overflow-hidden shadow-xl aspect-video">
                <img src="assets/project-3.png" alt="Xfini Academy System" className="w-full h-full object-cover rounded-2xl" />
              </div>
              ...
              <div className="glass-panel p-6 rounded-3xl">
                ...
                <table className="w-full text-xs sm:text-sm">
                  <tbody>
                    ...
                    <tr className="border-b border-white/5">
                      <td className="py-2.5 text-text-muted">Core Pages</td>
                      <td className="py-2.5 text-white font-semibold text-right">10+ Responsive Pages</td>
                    </tr>
                    <tr className="border-b border-white/5">
                      <td className="py-2.5 text-text-muted">Lead Generation</td>
                      <td className="py-2.5 text-white font-semibold text-right">Enquiry System</td>
                    </tr>
                    <tr className="border-b border-white/5">
                      <td className="py-2.5 text-text-muted">Performance</td>
                      <td className="py-2.5 text-white font-semibold text-right">Mobile Optimized</td>
                    </tr>
                    <tr className="border-b border-white/5">
                      <td className="py-2.5 text-text-muted">Content Management</td>
                      <td className="py-2.5 text-white font-semibold text-right">Dynamic Content</td>
                    </tr>
                    <tr className="border-b border-white/5">
                      <td className="py-2.5 text-text-muted">Architecture</td>
                      <td className="py-2.5 text-white font-semibold text-right">Educational Website</td>
                    </tr>
                  </tbody>
                </table>

                <div className="mt-6 flex flex-col gap-2">
                  <a href="https://xfiniacademy.netlify.app" target="_blank" className="w-full py-2.5 rounded-xl font-bold text-xs inline-flex items-center justify-center gap-1.5 bg-white text-bg-primary hover:bg-white/95 transition-all shadow-md">
                    Visit Live Website
                  </a>
                  <a href="https://github.com/roji370/briffini-Academy.git" target="_blank" className="w-full glass-button py-2.5 rounded-xl font-bold text-xs inline-flex items-center justify-center gap-1.5 text-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start text-left">
              <div className="lg:col-span-5 glass-panel rounded-3xl p-6">
                ...
                <form onSubmit={handleCommentSubmit} className="flex flex-col gap-4">
                  <div>
                    <label htmlFor="p3-username" className="block text-xxs font-bold uppercase tracking-wider text-text-muted mb-1.5">Your Name</label>
                    <input
                      type="text"
                      id="p3-username"
                      value={username}
                  ...
                  <div>
                    <label htmlFor="p3-comment" className="block text-xxs font-bold uppercase tracking-wider text-text-muted mb-1.5">Message</label>
                    <textarea
                      id="p3-comment"
                      value={commentText}
